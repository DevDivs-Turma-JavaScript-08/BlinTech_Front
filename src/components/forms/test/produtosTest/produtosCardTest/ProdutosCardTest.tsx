...
function ProdutosCardTest({ seguro }: CardPostagensProps) {
		...
		<div
			...
			<div className="flex flex-col gap-4">
				...
				<div className="flex justify-around items-center gap-4 mt-2">
					<Link
						to={`/produtos/atualizar/${seguro.id}`}
				...
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
					<div className="bg-(--primary-dark) p-6 rounded-2xl shadow-2xl w-96 animate-fade-in">
						...
						<div className="flex justify-end gap-4">
							...
							<button className="px-4 py-2 rounded-md font-semibold bg-(--primary) text-white transition-all duration-300 hover:scale-105 hover:bg-(--primary-dark) hover:shadow-lg hover:shadow-(--primary-light)/40">
								Excluir
							</button>
						</div>
					</div>
...
export default ProdutosCardTest;
