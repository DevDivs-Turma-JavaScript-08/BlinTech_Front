...
function PaginaSobre() {
	return (
		<AnimatePresence mode="wait">
			<motion.main
				className="flex flex-col bg-[url(https://i.imgur.com/x3Gn2Fn.png)] bg-repeat-x justify-center items-center text-white"
						...
						<div className="grid md:grid-cols-2 gap-12 items-center">
							<div className="p-8 rounded-2xl">
								...
								<p className="text-lg mb-6 leading-relaxed opacity-90">
									A Blintech nasceu da paixão por tecnologia e inovação. Fundada em 2020, nossa empresa começou como um pequeno time de
									desenvolvedores visionários que acreditavam no poder da tecnologia para transformar negócios.
								</p>
								<p className="text-lg leading-relaxed opacity-90">
									Hoje, somos uma empresa líder em soluções tecnológicas, atendendo clientes em todo o Brasil com produtos e serviços de alta
									qualidade que impulsionam o crescimento e a eficiência dos negócios.
								</p>
							</div>
				...
				{/* Call to Action */}
				<motion.section
					className="text-center w-full flex justify-center mb-20"
					initial={{ opacity: 0 }}
