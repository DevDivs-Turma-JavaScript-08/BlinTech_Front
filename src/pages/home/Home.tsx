...
function Home() {
	...
	return (
		<main className="flex flex-col w-full bg-(--primary-ex-dark) text-white">
			...
			{/* Categorias */}
			<section className="bg-[url(https://i.imgur.com/jh5VGgQ.png)] bg-repeat-x bg-(--tertiary) flex flex-col items-center px-10 pb-5 pt-20 gap-3">
				<h2 className="text-(--primary-dark) text-4xl font-bold"> Confira nossas categorias de Seguros</h2>
				<div className="h-[400px] w-full flex justify-center items-center">Lista de Seguros</div>
			</section>
